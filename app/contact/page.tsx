        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            ...
            <Card className="p-8 text-center hover:shadow-lg transition-shadow">
              ...
              <a href="mailto:info@landmarkestates.com" className="text-accent font-bold hover:underline">
            ...
            <Card className="p-8">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-primary text-primary-foreground py-4 rounded-lg font-bold hover:bg-primary/90 transition-all flex items-center justify-center gap-2 text-lg"
                  >
                    <Send size={20} />
                    Send Message
                  </button>
