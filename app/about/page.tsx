    ...
    <>
      ...
      <main className="min-h-screen bg-background">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="animate-fade-in-left">
                <h1 className="text-4xl md:text-5xl font-bold mb-6 text-foreground animate-fade-in-up">
              ...
              <div className="relative h-80 md:h-96 rounded-lg overflow-hidden shadow-lg animate-fade-in-right">
                <Image
                  src="/about-us.jpg"
        ...
        <section className="bg-muted py-20 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-12 text-center text-foreground animate-fade-in-down">Why Choose Us</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-background p-8 rounded-lg border border-border hover-float animate-stagger-1">
              ...
              <div className="bg-background p-8 rounded-lg border border-border hover-float animate-stagger-2">
              ...
              <div className="bg-background p-8 rounded-lg border border-border hover-float animate-stagger-3">
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-12 text-center text-foreground animate-fade-in-down">Our Core Values</h2>
        ...
        <section className="bg-gradient-to-r from-primary to-primary/80 py-20 px-4 text-center">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-3xl font-bold mb-6 text-primary-foreground animate-fade-in-up">
              Ready to Invest?
            </h2>
            <p className="text-lg text-primary-foreground/90 mb-8 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            ...
            <div className="flex gap-4 justify-center flex-wrap animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              ...
              <Link href="/contact">
                <Button variant="outline" size="lg" className="bg-transparent text-primary-foreground border-primary-foreground hover:bg-primary-foreground/10 hover-float">
                  Get in Touch
                </Button>
              </Link>
            </div>
