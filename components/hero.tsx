    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="space-y-6">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white leading-tight text-balance">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
            <Link
              href="/plots"
              className="inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-8 py-4 rounded-lg hover:bg-primary/90 transition-all font-semibold text-lg group"
            >
              Explore Plots
              <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
            </Link>
            <button className="inline-flex items-center justify-center gap-2 bg-white/20 backdrop-blur-sm text-white px-8 py-4 rounded-lg hover:bg-white/30 transition-all font-semibold border border-white/30 text-lg">
              Schedule Tour
            </button>
          </div>
